...
namespace tuddbs {
   ...
   struct simq_vector_builder_t {
      ...
      simq_vector_builder_t( ColumnContainer & column_container ) : svw{ column_container } { }
   ...
   struct simq_vector_builder_t< simq_vector_builder_gather_t, ColumnContainer, NumberOfQueries > {
      ...
      typename VectorExtension::vector_t
      get_and_increment( void ) {
         return simq_vector_builder_gather_t< ColumnContainer, NumberOfQueries, T, VectorExtension >::get_and_increment( svw );
      }
