...
namespace tuddbs {
   ...
   struct simq_column_vector_view_t {
      static_assert( ColumnContainer::number_or_columns_t::value <= NumberOfQueries,
      ...
      std::integral_constant<
         std::size_t,
         vector_constants_t< VectorExtension >::vector_element_count_t::value / ColumnContainer::number_or_columns_t::value
      >;
      ...
      FORCE_INLINE
      static constexpr std::size_t get_incrementor( void ) {
         return simq_column_vector_view_impl_t< ColumnContainer, NumberOfQueries, T, VectorExtension >::get_incrementor();
      }
      ...
      {
         simq_column_vector_view_impl_t< ColumnContainer, NumberOfQueries, T, VectorExtension >::init( p_container, column_data_ptr );
...
//            assert( offset <= std::numeric_limits< T >::max() );
   ...
   struct simq_value_vector_view_t {
      ...
      std::integral_constant<
         std::size_t,
         vector_constants_t< VectorExtension >::vector_element_count_t::value / ValueContainer::number_or_queries_t::value
      >;
