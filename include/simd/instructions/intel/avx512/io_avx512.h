...
namespace tuddbs {
   ...
   load< avx512< uint8_t > >(
      ...
      return _mm512_load_si512( reinterpret_cast< void const * >( a ) );
   }
...
*/
   ...
   struct gather_impl< avx512< uint8_t >, Scale > {
      ...
      static apply(
         ...
         typename vector_constants_t< avx512< uint8_t > >::array_t tmp;
         _mm512_store_si512( reinterpret_cast< void * >( tmp.data() ), vindex );
         for( std::size_t i = 0; i < vector_constants_t< avx512< uint8_t > >::vector_element_count_t::value; ++i ) {
   ...
   struct gather_impl< avx512< uint16_t >, Scale > {
      ...
      static apply(
         ...
         typename vector_constants_t< avx512< uint16_t > >::array_t tmp;
         _mm512_store_si512( reinterpret_cast< void * >( tmp.data() ), vindex );
         for( std::size_t i = 0; i < vector_constants_t< avx512< uint16_t > >::vector_element_count_t::value; ++i ) {
            tmp[ i ] = *( base + ( tmp[ i ] * Scale ) );
         }
         return _mm512_load_si512( reinterpret_cast< void const * >( tmp.data() ) );
      }
