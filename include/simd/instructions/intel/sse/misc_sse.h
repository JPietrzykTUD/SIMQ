...
namespace tuddbs {
   template< >
   char const * vector_extension_to_str< sse< uint8_t > >( void ) {
      return "SSE;u8";
   }
   template< >
   char const * vector_extension_to_str< sse< uint16_t > >( void ) {
      return "SSE;u16";
   }
   template< >
   char const * vector_extension_to_str< sse< uint32_t > >( void ) {
      return "SSE;u32";
   }
   template< >
   char const * vector_extension_to_str< sse< uint64_t > >( void ) {
      return "SSE;u64";
   }
