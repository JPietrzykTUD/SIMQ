...
namespace tuddbs {
   ...
   return
   _mm_set_epi8(val15, val14, val13, val12, val11, val10, val9, val8, val7, val6, val5, val4, val3, val2, val1, val0
   );
}
...
return
_mm_set_epi16(val7, val6, val5, val4, val3, val2, val1, val0
);
}
...
return
_mm_set_epi32(val3, val2, val1, val0
);
}
