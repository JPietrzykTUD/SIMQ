...
bool test( std::size_t data_count ) {
   ...
   using value_array_t = value_array< avx512< T >, QueryCount >;
   ...
   for( std::size_t i = 0; i < data_count; i += incrementor ) {
      sequential_buffer = store< avx512< T > >( sequential_buffer, svb_for_gather.get_and_increment( ) );
   }
   sequential_filter_impl< avx512< T >, point_filter_lt_core >::apply( expected_column, sequential_column, predicate_vec );
   /**
   ...
   filter_impl< avx512< T >, svb_t, point_filter_lt_core >::apply( result_column, svb, predicate_vec );
...
int main( void ) {
   ...
   result &= test< uint8_t, 1, 64 >( 128 );
   result &= test< uint8_t, 2, 64 >( 128 );
   result &= test< uint8_t, 4, 64 >( 128 );
   result &= test< uint8_t, 8, 64 >( 128 );
   result &= test< uint8_t, 16, 64 >( 128 );
   result &= test< uint8_t, 32, 64 >( 128 );
   result &= test< uint8_t, 64, 64 >( 128 );
   ...
   result &= test< uint16_t, 1, 32 >( 128 );
   result &= test< uint16_t, 2, 32 >( 128 );
   result &= test< uint16_t, 4, 32 >( 128 );
   result &= test< uint16_t, 8, 32 >( 128 );
   result &= test< uint16_t, 16, 32 >( 128 );
   result &= test< uint16_t, 32, 32 >( 128 );
   ...
   result &= test< uint32_t, 1, 16 >( 128 );
   result &= test< uint32_t, 2, 16 >( 128 );
   result &= test< uint32_t, 4, 16 >( 128 );
   result &= test< uint32_t, 8, 16 >( 128 );
   result &= test< uint32_t, 16, 16 >( 128 );
   ...
   result &= test< uint64_t, 1, 8 >( 128 );
   result &= test< uint64_t, 2, 8 >( 128 );
   result &= test< uint64_t, 4, 8 >( 128 );
   result &= test< uint64_t, 8, 8 >( 128 );
