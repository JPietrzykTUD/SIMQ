...
void run_vector_extension( std::size_t data_size ) {
   ...
   run_single_build_variant< simq_vector_builder_buffer_t, VectorExtension, ColumnCount, QueryCount >( data_size, true );
   run_single_build_variant< simq_vector_builder_buffer_t, VectorExtension, ColumnCount, QueryCount >( data_size, false );
   ...
   if( sizeof( typename VectorExtension::base_t ) > 2 ) {
      run_single_build_variant< simq_vector_builder_gather_t, VectorExtension, ColumnCount, QueryCount >( data_size, true );
      run_single_build_variant< simq_vector_builder_gather_t, VectorExtension, ColumnCount, QueryCount >( data_size, false );
   }
}
