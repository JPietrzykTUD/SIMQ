...
void run_vector_extension( std::size_t data_size ) {
   ...
   run_single_build_variant< simq_vector_builder_mask_broadcast_t, VectorExtension, ColumnCount, QueryCount >(
      data_size
   );
...
int main( void ) {
   using namespace tuddbs;
   const char
      * description = "#Results of the microbenchmark for different build variants for the SIMQ-Vector builder.";
